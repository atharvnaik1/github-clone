...
const Sidebar = () => {
  ...
  return (
    <aside className='flex flex-col items-center min-w-12 sm:w-16 sticky top-0 left-0 
   h-screen py-8 overflow-y-auto border-r
   bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-800
...
hover:bg-gray-800'> <IoHomeSharp size={20} /></Link>
        {authUser && (
